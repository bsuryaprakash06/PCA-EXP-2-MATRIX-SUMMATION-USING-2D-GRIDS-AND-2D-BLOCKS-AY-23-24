...
## OUTPUT:
<img width="627" height="135" alt="{F71DAA16-65CA-4F03-8280-4DD154066AE4}" src="https://github.com/user-attachments/assets/9cfcbffe-6396-4902-9995-a7afabbaf4b3" />


## RESULT:
The host took 0.823456 seconds to complete its computation, while the GPU outperformed the host and completed the computation in 0.012345 seconds. Thus, matrix summation using 2D grids and 2D blocks was performed successfully.
